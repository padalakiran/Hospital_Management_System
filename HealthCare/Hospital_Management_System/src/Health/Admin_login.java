		            ...
		            if (connection != null) {
                        ...
                        if(status) {
                	        ...
                	        case 4:
                	        	...
                	        	String sqls="select * from doctor where spc=?;";
                	        	...
                	        	while(resultSet.next()) {
                	        		...
                	        		String na=resultSet.getString("doctor_name");
                	        		long pno1=resultSet.getLong("phonenumber");
                	        		String mai=resultSet.getString("mail");
                	        		String spc=resultSet.getString("spc");
                	        		
                	        		System.out.println(id_p+" "+na+" "+pno1+" "+mai+" "+spc);
